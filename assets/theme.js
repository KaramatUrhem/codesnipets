/*
@license
  Base 2.0 by Base Themes (https://www.google.com/)
...
if (console && console.log) {
  console.log('Base 2.0 Theme ('+theme.settings.themeVersion+') by Base | Learn more at https://www.google.com/');
}
...
(function(){
  ...
  theme.Slideshow = (function() {
    ...
    var defaults = {
      ...
      autoPlay: false,
      avoidReflow: false, // custom by Base
      childNav: null, // element. Custom by Base instead of asNavFor
    ...
    Collection.prototype = Object.assign({}, Collection.prototype, {
      init: function() {
        ...
        if (this.context && this.context === 'featured-collection') {
          ...
          this.initPriceRange();
          this.sidebar.init();
          document.dispatchEvent(new CustomEvent('insertWithProductItem:init'));
          document.dispatchEvent(new CustomEvent('imageWithSlide:init'));
          document.dispatchEvent(new CustomEvent('loadmore:init'));
        }
      },
